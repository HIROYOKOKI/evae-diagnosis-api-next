...
export default function SoulProfileForm() {
  ...
  return (
    // グローバルCSSで背景が設定されるため、min-h-screenとflexプロパティは維持しつつ、
    // 背景画像やオーバーレイのdivは削除します。
    <div className="min-h-screen flex items-center justify-center text-cyan-100 font-sans px-4 py-8 overflow-hidden">
      {/* メインコンテンツエリア */}
